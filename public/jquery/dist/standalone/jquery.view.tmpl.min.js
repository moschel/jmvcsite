...
b.nodeType===1?[b]:[];d.call(a,b);B(c);n++}});$.View.register({suffix:"tmpl",renderer:function(a,b){return function(d){return $.tmpl(b,d)}},script:function(a,b){return"function(data){return ("+$.tmpl(b).toString()+").call(jQuery, jQuery, data); }"}});jQuery.View.ext=".tmpl"})(jQuery);
