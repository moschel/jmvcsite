...
(function(){jQuery.Controller.processors.subscribe=function(d,h,a,c){var b=OpenAjax.hub.subscribe(a,c);return function(){OpenAjax.hub.unsubscribe(b)}};jQuery.Controller.prototype.publish=function(){OpenAjax.hub.publish.apply(OpenAjax.hub,arguments)}})(jQuery);
