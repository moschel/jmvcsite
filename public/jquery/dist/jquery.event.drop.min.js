...
var i=e?jQuery.data(this,"offset",f.offset()):f.offset(),j=f.width();f=f.height();(res=!(i.top>a+c||i.top+f<a||i.left>g+b||i.left+j<g))&&h.push(this)});return this.pushStack(jQuery.unique(h),"withinBox",jQuery.makeArray(arguments).join(","))}})(true);
...
d.sourceIndex&&4;g+=this[0].sourceIndex>d.sourceIndex&&2;g+=(this[0].ownerDocument!==d.ownerDocument||this[0]!=a&&this[0].sourceIndex<=0||d!=a&&d.sourceIndex<=0)&&1}else{a=document.createRange();var b=document.createRange();a.selectNode(this[0]);b.selectNode(d);a.compareBoundaryPoints(Range.START_TO_START,b)}return g}})(true);
...
[]}});d.Drag.responder=d.Drop;d.extend(d.Drop.prototype,{callHandlers:function(a,b,c,e){for(var h=this[a]?this[a].length:0,f=0;f<h;f++)this[a][f].call(b||this.element[0],c,this,e)},cache:function(a){this._cache=a!=null?a:true},cancel:function(){this._canceled=true}})})(true);
